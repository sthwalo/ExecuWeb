import {  Shield, Users, Target, Star, LucideIcon } from 'lucide-react';
...
export default function About() {
  const [imageLoaded, setImageLoaded] = useState<LoadingState>({});
    ...
    <div className="container py-12 space-y-12">
      ...
      <div className="relative h-64 rounded-lg overflow-hidden">
        <img
          ...
          style={{ opacity: imageLoaded.hero ? 1 : 0.1 }}
        />
      </div>
